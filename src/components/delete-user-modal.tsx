              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-bold text-gray-900 dark:text-white">
                    {phase === "done" ? "Deleted" : phase === "failed" ? "Stopped" : `Delete ${kind}`}
                  </h2>
              ...
              <div className="p-6 space-y-4">
                <div className="p-3.5 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 text-sm text-red-700 dark:text-red-300 space-y-1.5">
                  ...
                  <ul className="text-[12px] space-y-0.5 ml-5 list-disc">
                    <li>All campaign applications &amp; activity</li>
                    {kind === "brand" && <li>All campaigns owned by this brand</li>}
                    <li>All service orders &amp; their history</li>
                    {kind === "influencer" && <li>Featured-creator &amp; story listings</li>}
                    <li>The {kind} profile row</li>
                    <li>The authentication account (phone &amp; Instagram tokens)</li>
                  </ul>
                ...
                <div className="p-5 max-h-[60vh] overflow-y-auto">
                  ...
                  {phase === "done" && (
                    <div className="mt-4 p-3.5 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 border border-emerald-200 dark:border-emerald-800 flex items-center gap-3">
                      ...
                      <p className="text-sm text-emerald-700 dark:text-emerald-300">All steps completed. Redirecting…</p>
                    </div>
                  )}

                  {phase === "failed" && (
                    <div className="mt-4 p-3.5 rounded-xl bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800">
                      <p className="text-sm text-red-700 dark:text-red-300">Deletion stopped at the failed step. Earlier steps already completed cannot be undone.</p>
                    </div>
                  )}
                </div>
