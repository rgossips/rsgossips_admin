...
export function DeliverFinalForm({ orderId }: { orderId: string }) {
  const t = useTranslations("DashboardQuoteRequestsComponentsDeliverFinalForm");
  ...
  if (!open) {
    return (
      <div className="bg-white dark:bg-gray-900 border border-emerald-200 dark:border-emerald-800 rounded-xl p-5 space-y-3">
        <div>
          <h3 className="text-sm font-semibold text-gray-900 dark:text-white">{t("collapsed.title")}</h3>
